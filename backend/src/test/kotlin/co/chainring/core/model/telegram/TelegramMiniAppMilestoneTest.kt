...
import co.chainring.core.model.telegram.miniapp.TelegramMiniAppMilestoneReward
...
class TelegramMiniAppMilestoneTest {
    ...
    fun testNextMilestone() {
        val testCases = listOf(
            ...
            BigDecimal("5000") to TelegramMiniAppMilestoneReward(cp = "9000".crPoints(), invites = 3),
            BigDecimal("36000") to TelegramMiniAppMilestoneReward(cp = "126000".crPoints(), invites = 10),
    ...
    fun testPreviousMilestone() {
        val testCases = listOf(
            ...
            BigDecimal("9000") to TelegramMiniAppMilestoneReward(cp = "9000".crPoints(), invites = 3),
            BigDecimal("36000") to TelegramMiniAppMilestoneReward(cp = "36000".crPoints(), invites = 6),
            BigDecimal("126000") to TelegramMiniAppMilestoneReward(cp = "126000".crPoints(), invites = 10),
